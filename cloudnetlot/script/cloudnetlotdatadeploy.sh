...
if [ -f "${BASE}/cloudnetlotdata/emqttd/emqttdconf.tar.gz" ];then
    tar zxf ${BASE}/cloudnetlotdata/emqttd/emqttdconf.tar.gz -C ${BASE}/cloudnetlotdata/emqttd/
    rm -rf ${BASE}/cloudnetlotdata/emqttd/emqttdconf.tar.gz
fi
